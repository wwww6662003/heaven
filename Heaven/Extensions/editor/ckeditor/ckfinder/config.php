 ...
 */
//定义APP_ROOT的路径.
define('APP_ROOT', substr(dirname(__FILE__), 0, -36));
//define('APP_ROOT', 'E:/MyPHP/heaven');
...
*/
//$baseUrl = dirname(__FILE__).'/userfiles/';
$baseUrl = substr(dirname($_SERVER['SCRIPT_NAME']), 0, -55).'/upload/';
/*
