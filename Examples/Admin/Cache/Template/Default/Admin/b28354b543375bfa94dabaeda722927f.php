...
<title>top</title>
<link href="http://admin.hello.com/Public/skin/css/base.css" rel="stylesheet" type="text/css">
...
{
  text-align:center;
	background:url(http://admin.hello.com/Public/skin/images/frame/topitembg.gif) 0px 3px no-repeat;
	width:82px;
	height:26px;
	line-height:28px;
}
...
<body bgColor='#ffffff'>
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="http://admin.hello.com/Public/skin/images/frame/topbg.gif">
  <tr>
    <td width='20%' height="60"><img src="http://admin.hello.com/Public/skin/images/frame/logo.gif" /></td>
    <td width='80%' align="right" valign="bottom">
    	<table width="750" border="0" cellspacing="0" cellpadding="0">
      <tr>
      <td align="right" height="26" style="padding-right:10px;line-height:26px;">
        	您好：<span class="username">admin</span>，欢迎使用内容管理系统！
        	[<a href="http://www.hello.com/" target="_blank">网站主页</a>]
        	[<a href="" target="_blank">修改密码</a>]
        	[<a href="http://admin.hello.com/login/logout" target="_top">注销退出</a>]&nbsp;
      </td>
      </tr>
      <tr>
        <td align="right" height="34" class="rmain">
		<dl id="tpa">
		<dd class='img'><a href="javascript:ChangeMenu(-1);"><img vspace="5" src="http://admin.hello.com/Public/skin/images/frame/arrl.gif" border="0" width="5" height="8" alt="缩小左框架"  title="缩小左框架" /></a></dd>
		<dd class='img'><a href="javascript:ChangeMenu(0);"><img vspace="3" src="http://admin.hello.com/Public/skin/images/frame/arrfc.gif" border="0" width="12" height="12" alt="显示/隐藏左框架" title="显示/隐藏左框架" /></a></dd>
		<dd class='img' style="margin-right:10px;"><a href="javascript:ChangeMenu(1);"><img vspace="5" src="http://admin.hello.com/Public/skin/images/frame/arrr.gif" border="0" width="5" height="8" alt="增大左框架" title="增大左框架" /></a></dd>
		<dd><div class='itemsel' id='item1' onMouseMove="mv(this,'move',1);" onMouseOut="mv(this,'o',1);"><a href="http://admin.hello.com/menu" onclick="changeSel(1)" target="menu">主菜单</a></div></dd>
